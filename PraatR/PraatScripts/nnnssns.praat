...
if type$="Create" | type$="Modify"
	do ( replace$ (command$, "__", " ", 0), a1, a2, a3, replace$ (a4$, "__", " ", 0), replace$ (a5$, "__", " ", 0), a6, replace$ (a7$, "__", " ", 0) )
	if filetype$="binary"
	...
	result_string$ = do$ ( replace$ (command$, "__", " ", 0), a1, a2, a3, replace$ (a4$, "__", " ", 0), replace$ (a5$, "__", " ", 0), a6, replace$ (a7$, "__", " ", 0) )
	if simplify
