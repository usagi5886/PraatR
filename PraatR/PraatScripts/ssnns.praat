...
if type$="Create" | type$="Modify"
	do ( replace$ (command$, "__", " ", 0), replace$ (a1$, "__", " ", 0), replace$ (a2$, "__", " ", 0), a3, a4, replace$ (a5$, "__", " ", 0) )
	if filetype$="binary"
	...
	result_string$ = do$ ( replace$ (command$, "__", " ", 0), replace$ (a1$, "__", " ", 0), replace$ (a2$, "__", " ", 0), a3, a4, replace$ (a5$, "__", " ", 0) )
	if simplify
