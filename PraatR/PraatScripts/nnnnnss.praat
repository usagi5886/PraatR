...
if type$="Create" | type$="Modify"
	do ( replace$ (command$, "__", " ", 0), a1, a2, a3, a4, a5, replace$ (a6$, "__", " ", 0), replace$ (a7$, "__", " ", 0) )
	if filetype$="binary"
	...
	result_string$ = do$ ( replace$ (command$, "__", " ", 0), a1, a2, a3, a4, a5, replace$ (a6$, "__", " ", 0), replace$ (a7$, "__", " ", 0) )
	if simplify
