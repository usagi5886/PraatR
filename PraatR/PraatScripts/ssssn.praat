...
if type$="Create" | type$="Modify"
	do ( replace$ (command$, "__", " ", 0), replace$ (a1$, "__", " ", 0), replace$ (a2$, "__", " ", 0), replace$ (a3$, "__", " ", 0), replace$ (a4$, "__", " ", 0), a5 )
	if filetype$="binary"
	...
	result_string$ = do$ ( replace$ (command$, "__", " ", 0), replace$ (a1$, "__", " ", 0), replace$ (a2$, "__", " ", 0), replace$ (a3$, "__", " ", 0), replace$ (a4$, "__", " ", 0), a5 )
	if simplify
